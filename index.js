window.onload = function() {
  emailjs.init("5tfG93RgjAaO6v_2d"); // Initialize with your EmailJS public key
  
  // Typewriter Effect
  const text = "Aspiring IT Student | Software Developer | Web Developer";
  ...
  contactForm.addEventListener("submit", (event) => {
    ...
    const templateParams = {
      ...
      email: document.getElementById("email").value, // Optionally, include the email address
    };
